...
API.get('/allimg').then(function (res) {
  console.log(res);
  if (res.status === 200 && res.data.code === 0) setList(res.data.data);
}).catch(function (error) {
  console.log(error);
});

var setList = function setList(arr) {
...
},{"axios":"node_modules/axios/index.js","./index.less":"index.less"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/crawler_client.77de5100.js.map