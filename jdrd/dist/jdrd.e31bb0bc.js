...
exports.default = vue_1.default.extend({
  data: function data() {
    return {
      bundler: 'Parcel'
        ...
        var $f97dba = exports.default || module.exports;
      
      if (typeof $f97dba === 'function') {
        $f97dba = $f97dba.options;
      }
    
        /* template */
        Object.assign($f97dba, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", [
    ...
    _c("div", [_vm._v("123 " + _vm._s(_vm.bundler))])
  ])
}
var staticRenderFns = []
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f97dba', $f97dba);
          } else {
            api.reload('$f97dba', $f97dba);
          }
        }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "63814" + '/');
